...
public class shoping_cart {
	...
	if (result.equalsIgnoreCase("a")) {
		...
		System.out.println(" ONEPLUS 10R\n"+
				   "cost : 34999\n"+
				   "RAM : 8GB\n"+
				   "internal storage : 128GB\n");
		System.out.println("Do you wish to purchase our product(type yes/no)");
	...
	if (result.equalsIgnoreCase("a")) {
		...
		System.out.println("ACER EXTENSA 15\n"+
				   "Processor: Intel Core I5 11th Gen\n"+
				   "cost : 42999\n"+
				   "RAM : 8GB\n"+
				   "internal storage : 512GB SSD\n"+
	...
	result = sc.next();
	if (result.equalsIgnoreCase("a")) {
		System.out.println("DELL VOSTRO 3420\n"+
		...
		System.out.println("DELL INSPIRON 3520\n"+
		...
		System.out.println("DELL GAMING G15 5525\n"+
				   "Processor: Intel Core I5 12th Gen\n"+
				   "cost : 74490\n"+
				   "RAM : 16GB\n"+
				   "internal storage : 512GB SSD\n"+
				   "Graphics: RTX 3050 4GB Graphics");
		System.out.println("Do you wish to purchase our product(type yes/no)");
		String type_2=sc.next();
		if(type_2.equalsIgnoreCase("YES")==true) {
			System.out.println("Thank you for purchasing\n" + "Visit again");
		...
		System.out.println("DELL INSPIRON 3511\n"+
	...
	if (result.equalsIgnoreCase("a")) {
		...
		System.out.println("LENOVO YOGA SLIM 7 PRO\n"+
		...
		if(type_2.equalsIgnoreCase("YES")==true) {
			...
			if (result.equalsIgnoreCase("a")) {
				...
				result = sc.next();
				if (result.equalsIgnoreCase("a")) {
					System.out.println("FIRE BOLTT NINJA\n"+
									   "cost : 1799\n"+
					...
					System.out.println("FIRE BOLTT PHOENIX\n"+
							   "cost : 1799\n"+
							   "SMART WATCH WITH BLUETOOTH CALLING\n"+
	...
	if (result.equalsIgnoreCase("a")) {
		...
		System.out.println("NOISE PULSE GO BUZZ\n"+
				   "cost : 1699\n"+
				   "SMART WATCH WITH BLUETOOTH CALLING\n"+
				   "SPO2 MONITORING\n"+
				   "100 SPORTS MODES");
		...
		System.out.println("NOISE PULSE 2\n"+
				   "cost : 1899\n"+
				   "SMART WATCH WITH BLUETOOTH CALLING\n"+
				   "SPO2,HEART RATE MONITORING\n"+
				   "100 SPORTS MODES IP67 RATING");
		...
		System.out.println("NOISE COLORFIT PRO 4\n"+
				   "cost : 3999\n"+
				   "SMART WATCH WITH BLUETOOTH CALLING\n"+
				   "SPO2,HEART RATE MONITORING\n"+
				   "100 SPORTS MODES IP67 RATING");
	...
	if (result.equalsIgnoreCase("a")) {
		...
		if(type_2.equalsIgnoreCase("YES")==true) {
			...
			result = sc.next();
			if (result.equalsIgnoreCase("a")) {
				System.out.println("a.Samsung 32in\n"+
									"b.Samsung 43in\n"+
									"c.Samsung 55in\n"+
									"d.Samsung 65in\n");
				...
				result = sc.next();
				if (result.equalsIgnoreCase("a")) {
					System.out.println("Samsung 32in\n"+
										"SMART TV\n"+
	...
	if (result.equalsIgnoreCase("a")) {
		...
		if(type_2.equalsIgnoreCase("YES")==true) {
			...
			System.out.println("Thank you");
				...
				System.out.println("a.ONEPULSE 32In\n"+
						"b.ONEPULSE 43In\n"+
						"c.ONEPULSE 50In\n"+
						"d.ONEPULSE 55In\n");
	System.out.println("Select an option to see the features of televisions");
	...
	if (result.equalsIgnoreCase("a")) {
		...
		if(type_2.equalsIgnoreCase("YES")==true) {
			...
			if (result.equalsIgnoreCase("a")) {
				...
				result = sc.next();
				if (result.equalsIgnoreCase("a")) {
					System.out.println("Samsung Galaxy Tab S7\n"+
									   "cost : 40999\n"+
									   "RAM : 4GB\n"+
									   "storage : 64GB\n");
					System.out.println("Do you wish to purchase our product(type yes/no)");
					...
					System.out.println("Samsung Galaxy Tab S8\n"+
							   "cost : 51990\n"+
							   "RAM : 8GB\n"+
							   "storage : 128GB\n");
					System.out.println("Do you wish to purchase our product(type yes/no)");
					...
					System.out.println("Samsung Galaxy Tab A7\n"+
							   "cost : 11990\n"+
							   "RAM : 3GB\n"+
							   "storage : 32GB\n");
					System.out.println("Do you wish to purchase our product(type yes/no)");
					...
					System.out.println("Samsung Galaxy Tab A8\n"+
							   "cost : 16999\n"+
							   "RAM : 4GB\n"+
							   "storage : 64GB\n");
					System.out.println("Do you wish to purchase our product(type yes/no)");
	...
	if (result.equalsIgnoreCase("a")) {
		...
		System.out.println("Lenovo Tab M7 3rd Gen\n"+
				   "cost : 6999\n"+
				   "RAM : 2GB\n"+
				   "storage : 32GB\n");
		System.out.println("Do you wish to purchase our product(type yes/no)");
		...
		if(type_2.equalsIgnoreCase("YES")==true) {
			...
			System.out.println("Thank you");
				...
				System.out.println("a.Realme Pad X\n"+
						"b.Realme Pad \n"+
						"c.Realme Pad Mini\n"+
						"d.Realme Pad Mini\n");
	System.out.println("Select an option to see the features of tablets");
	result = sc.next();
	if (result.equalsIgnoreCase("a")) {
		System.out.println("Realme Pad X\n"+
				   "cost : 28459\n"+
				   "RAM : 6GB\n"+
				   "storage : 128GB\n");
		System.out.println("Do you wish to purchase our product(type yes/no)");
		...
		System.out.println("Realme Pad Mini\n"+
				   "cost : 10000\n"+
				   "RAM : 3GB\n"+
				   "storage : 32GB\n");
		System.out.println("Do you wish to purchase our product(type yes/no)");
	...
	result = sc.next();
	if (result.equalsIgnoreCase("a")) {
		System.out.println("Readmi Pad 1\n"+
				   "cost : 17999\n"+
				   "RAM : 4GB\n"+
				   "storage : 128GB\n");
		System.out.println("Do you wish to purchase our product(type yes/no)");
		...
		System.out.println("Readmi Pad 2\n"+
				   "cost : 19999\n"+
				   "RAM : 6GB\n"+
				   "storage : 128GB\n");
		System.out.println("Do you wish to purchase our product(type yes/no)");
		...
		System.out.println("Readmi Pad 5(1)\n"+
				   "cost : 28999\n"+
				   "RAM : 6GB\n"+
				   "storage : 256GB\n");
		System.out.println("Do you wish to purchase our product(type yes/no)");
		...
		System.out.println("Readmi Pad 5(2)\n"+
				   "cost : 26999\n"+
				   "RAM : 6GB\n"+
				   "storage : 128GB\n");
		System.out.println("Do you wish to purchase our product(type yes/no)");
